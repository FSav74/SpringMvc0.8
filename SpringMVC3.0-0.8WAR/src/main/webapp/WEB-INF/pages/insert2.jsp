...
<link href="<%=request.getContextPath() %>/resources/css/searchAndDetails.css" rel="stylesheet" type="text/css" />
	...
	<form:form commandName="insertFormBean" action="${pageContext.request.contextPath}/insert2.do" method="post">
	
	<!-- Errori validatzione -->
	<form:errors path="*" cssClass="errorblock" element="div" />
	
			<fieldset>
				<legend>Inserisci libro E Autore senza controllo di esistenza</legend>
				<div class="myRow">
				...
				<div class="myRow">
				 <div class="myCol"><label for="location" class="title">Nome Autore</label></div>
				 <div class="myCol"><form:input path="nomeAutore"/></div>
				 <div class="myCol"><label class="title" for="name">Cognome Autore:</label></div>
