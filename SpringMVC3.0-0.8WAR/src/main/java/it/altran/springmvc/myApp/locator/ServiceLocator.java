...
public class ServiceLocator {
	...
	@PostConstruct
	public void init() throws ServiceLocatorException, ConfigurationException{
	Properties jndiProps = new Properties();
    	
		//jboss eap 6.1
//    	jndiProps.put(Context.INITIAL_CONTEXT_FACTORY, "org.jboss.naming.remote.client.InitialContextFactory");       	
//    	jndiProps.put(Context.PROVIDER_URL,"remote://localhost:4447");
		jndiProps.put(Context.INITIAL_CONTEXT_FACTORY, configurationProperties.getProperty(configurationProperties.INITIAL_CONTEXT_FACTORY));       	
    	jndiProps.put(Context.PROVIDER_URL,configurationProperties.getProperty(configurationProperties.PROVIDER_URL));
    
        
    	try {
    		
    		ic = new InitialContext(jndiProps);
            System.out.println("Creato jndi InitialContext..................");
	...
	public  <T> T lookUp(String name ) throws ServiceLocatorException{
		try{
			
			Object object = ic.lookup(name);
			System.out.println("lookup.................."+object.getClass());
			return (T) object;
					}catch (NamingException ne) {
    		throw new ServiceLocatorException( ne );
    	}
...
//    	try {
//    		return (UserTransaction)ic.lookup("javax.transaction.UserTransaction");
//    	}catch (NamingException ne) {
//    		throw new ServiceLocatorException( ne );
//    	}
//    }
